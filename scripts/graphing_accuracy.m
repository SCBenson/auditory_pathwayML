...
%     save(saveResultsAs,'accuracy');
    ...
    %% Number of neurons with 18% or more accuracy rating
    threshold_of_success = (yGraph > .18);
...
%%
B_important = TreeBagger(400,training_input(:,thresholded_importance),training_output,'OOBPrediction','on','OOBPredictorImportance','off'); 
...
answer.tbgmdl = B;
answer.tbgmdl_bootstrap_tbmdl = B_important;
